...
image::images/05-wificonfig/smart-config.png[SmartConfig, role="center", align="center", width=400]
...
.Gói tin UDP
image::images/05-wificonfig/data_packet.png[Cấu trúc gói tin UDP, role="center", align="center", width=400]
