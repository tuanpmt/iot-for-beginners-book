...
image::images/05-wificonfig/wifi_manager.png[kết nối bằng wifi manager, role="center", align="center", width=400]

image::images/05-wificonfig/wifi_manager1.png[Giao diện wifi manager, role="center", align="center", width=400]
...
image::images/05-wificonfig/wifi_manager2.png[Kết nối bằng wifi manager , role="center", align="center", width=400]
