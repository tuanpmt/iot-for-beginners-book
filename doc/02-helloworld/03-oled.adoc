...
.OLED SSD1306
image::images/01-intro/oled.jpg[OLED SSD1306, width=400, align="center", role="center"]
...
.I2C Clock
image::images/02-helloworld/i2cClock.png[width=600, align="center", role="center"]

.Mô hình mạng I2C
image::images/01-intro/i2c-network.png[Mô hình mạng I2C, width=400, align="center", role="center"]
...
.ESP8266 với OLED
image::images/01-intro/oled-esp.png[ESP8266 với OLED, width=814, align="center", role="center"]
