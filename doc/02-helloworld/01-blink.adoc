...
image::images/02-helloworld/LED_symbol.svg[width=200, role="center", align="center"]

.Mạch có thể chạy được như sau
image::images/02-helloworld/led.png[width=400, role="center", align="center"]

**Arduino IDE**

.Arduini IDE
image::images/02-helloworld/arduino-ide.png[width=400, role="center", align="center"]
...
image::images/02-helloworld/btn-led.png[width=300, role="center", align="center"]
