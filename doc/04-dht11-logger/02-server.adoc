...
**Lưu ý** Cần phải có dữ liệu từ ESP8266 gửi lên server thì tại địa chỉ localhost:8000/get mới có dữ liệu.   
...
image::04-dht11/graphHtml.png[width=506, align="center"]