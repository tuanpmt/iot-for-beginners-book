...
include::04-starterkit.adoc[]

include::05-nodejs.adoc[]

include::06-prepare.adoc[]

== Tổng kết

Tới lúc này, bạn có thể đã có cái nhìn tổng quan về hệ sinh thái, công cụ và phương thức làm việc với ESP8266 cũng như tổng quan về hệ thống **IoT**. Đồng thời đã có thể bắt đầu việc phát triển ứng dụng cho ESP8266 ngay lập tức.
Tiếp theo chúng ta sẽ tìm hiểu những kiến thức cơ bản và cần thiết nhất để khởi động ứng dụng cho ESP8266.
