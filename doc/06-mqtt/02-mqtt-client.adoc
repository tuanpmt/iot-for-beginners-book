...
Ngoài ra có thể tạo thêm 1 connection và pulish các message vào topic `MQTTlens/test/#` với # là 1 nội dung bất kì. Ở Serial terminal của Arduino, chúng ta sẽ nhìn thấy nội dung của message gửi bởi MQTT lens bởi vì ESP8266 đã đăng kí nhận gói tin tại topic `MQTTlens/test/#`
