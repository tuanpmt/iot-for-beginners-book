...
Trong một số ứng dụng khác, chúng ta có 1 Server Websocket để thực hiện các tác vụ thời gian thực với các ứng dụng khác như Ứng dụng điện thoại, trình duyệt Web. Thì ESP8266 có thể kết nối trực tiếp vào các server này như 1 Websocket Client để tiếp nhận, hoặc gởi thông tin thông qua Websocket.
...
* Cho phép kết nối Websocket đến, bao gồm từ trình duyệt, hanh từ ESP8266
...
[source, html]
----
include::code/server/index.html[]
----

=== Node.js Websocket Server
Trong phần này chúng ta cần dùng thư viện Websocket `ws` https://github.com/websockets/ws. Bạn có thể cài đặt bằng cách:
...
[source, c]
----
include::code/WebSocketClient/WebSocketClient.ino[]
----
