...
image::images/07-websocket/same-ctrl.png[width=600, role="center", align="center"]
...
image::images/07-websocket/browser-esp.png[width=600, role="center", align="center"]
