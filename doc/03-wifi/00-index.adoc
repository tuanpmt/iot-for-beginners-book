...
.WiFi Access Point
image::images/03-wifi/router.jpg[WiFi Access Point, role="center", align="center", width=400]
...
.Mạng WiFi
image::images/03-wifi/ap-sta.png[WiFi Network, role="center", align="center", width=400]
