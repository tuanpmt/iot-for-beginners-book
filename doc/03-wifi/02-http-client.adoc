...
image::images/03-wifi/http1-req-res-details.png[Cách thức HTTP hoạt động, role="center", align="center", width=400]
...
.Cấu trúc 1 URL
image::images/03-wifi/http1-url-structure.png[URL, role="center", align="center", width=400]
...
.HTTPS Fingerprint
image::images/03-wifi/fingerprint.png[HTTPS Finger print, role="center", align="center", width=500]
...
image::images/03-wifi/btc.png[BTC Price, role="center", align="center", width=500]
